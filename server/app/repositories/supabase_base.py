...
class SupabaseMapper:
    ...
    def session_from_row(row: dict[str, Any]) -> SessionSummary:
        return SessionSummary(
            ...
            sleeping_percent=int(row.get("sleeping_percent") or 0),
            other_voice_percent=int(row.get("other_voice_percent") or 0),
            object_percent=int(row.get("object_percent") or 0),
            tab_switch_percent=int(row.get("tab_switch_percent") or 0),
